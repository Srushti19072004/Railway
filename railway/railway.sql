-- Host: localhost
-- Generation Time: Nov 04, 2022 at 01:13 PM
...
INSERT IGNORE INTO classseats (trainno, sp, dp, doj, class, fare, seatsleft) VALUES
(12, 'Chandigarh', 'Jaipur', '2024-10-30', 'AC1', 2200, 107),
(12, 'Chandigarh', 'Jaipur', '2024-10-25', 'AC1', 3200, 20),
(12, 'Chandigarh', 'Jaipur', '2024-11-28', 'AC3', 2400, 60),
(12, 'Chandigarh', 'Jaipur', '2024-10-30', 'EC', 1200, 100),
(12, 'Chandigarh', 'Jaipur', '2024-10-25', 'SL', 500, 200),
(12, 'Jaipur', 'Kolkata', '2024-10-26', 'AC1', 1434, 243),
(12, 'Jaipur', 'Kolkata', '2024-11-1', 'AC1', 2900, 15),
(12, 'Jaipur', 'Kolkata', '2024-10-30', 'AC3', 2100, 40),
(12, 'Jaipur', 'Kolkata', '2024-11-2', 'EC', 1500, 120),
(12, 'Jaipur', 'Kolkata', '2024-11-5', 'SL', 800, 250),
(12, 'Kolkata', 'Lucknow', '2024-11-28', 'AC1', 934, 322),
(12, 'Kolkata', 'Lucknow', '2024-11-12', 'AC1', 3100, 30),
(12, 'Kolkata', 'Lucknow', '2024-11-6', 'AC3', 1900, 30),
(12, 'Kolkata', 'Lucknow', '2024-10-28', 'EC', 1700, 150),
(12, 'Kolkata', 'Lucknow', '2024-11-9', 'SL', 700, 220),
(12, 'Lucknow', 'Delhi', '2024-11-10', 'AC1', 344, 326),
(12, 'Lucknow', 'Delhi', '2024-11-4', 'AC1', 2750, 20),
(12, 'Lucknow', 'Delhi', '2024-11-7', 'AC3', 2350, 60),
(12, 'Lucknow', 'Delhi', '2024-11-6', 'EC', 1100, 118),
(12, 'Lucknow', 'Delhi', '2024-11-3', 'SL', 900, 180),
(18, 'Chandigarh', 'Jaipur', '2024-11-25', 'AC1', 2420, 50),
(18, 'Chandigarh', 'Jaipur', '2024-10-29', 'AC3', 1700, 20),
(18, 'Chandigarh', 'Jaipur', '2024-10-30', 'CC', 750, 120),
(18, 'Jaipur', 'Delhi', '2024-11-30', 'AC1', 2750, 20),
(18, 'Jaipur', 'Delhi', '2024-11-3', 'AC3', 1200, 20),
(18, 'Jaipur', 'Delhi', '2024-10-27', 'CC', 900, 150),
(20, 'Delhi', 'Jaipur', '2024-11-30', 'AC1', 4500, 20),
(20, 'Delhi', 'Jaipur', '2024-10-26', 'AC2', 3200, 50),
(20, 'Delhi', 'Jaipur', '2024-10-30', 'AC3', 2700, 50),
(20, 'Delhi', 'Jaipur', '2024-12-30', 'SL', 900, 300);
...
INSERT IGNORE INTO resv (pnr, id, trainno, sp, dp, doj, tfare, class, nos, status) VALUES
(51, 4, 12, 'Chandigarh', 'Jaipur', '2024-10-26', 3300, 'AC1', 2, 'BOOKED'),
(57, 5, 12, 'Chandigarh', 'Jaipur', '2024-10-28', 2200, 'AC1', 1, 'CANCELLED'),
(58, 6, 20, 'Delhi', 'Jaipur', '2024-10-30', 11200, 'AC2', 4, 'CANCELLED'),
(59, 10, 12, 'Lucknow', 'Delhi', '2024-11-1', 2200, 'EC', 2, 'BOOKED');
--
-- Triggers `resv`
--
...
INSERT IGNORE INTO user (id, emailid, password, mobileno, dob) VALUES
(4, 'garvitjain@gmail.com', 'garvit', '9312201852', '2004-10-30'),
(5, 'deepakgoel@hotmail.com', 'deepak', '9312201853', '2005-10-30'),
(6, 'akhilkumar@yahoo.co.in', 'akhil', '9872231234', '2002-10-30'),
(7, 'ayushjain@outlook.com', 'ayush', '9810150525', '2001-10-30'),
(8, 'aakashbharadwaj@yahoo.com', 'aakash', '9013452635', '2004-10-30'),
(10, 'abhinavsingh@gmail.com', 'abhinav', '9876675567', '2004-10-30'),
(12, 'amanmalik@hotmail.com', 'aman', '9878876654', '2002-10-30'),
(19, 'dhruvgosian@gmail.com', 'dhruv', '9807890453', '2005-10-30'),
(20, 'chiragbansal@nsitonline.com', 'chirag', '9123456789', '2001-10-30');
...
DELIMITER //
CREATE TRIGGER before_insert_no_on_user 
BEFORE INSERT ON user
FOR EACH ROW
BEGIN
    -- Check length
    IF LENGTH(NEW.mobileno) != 10 THEN 
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'Mobile number must be exactly 10 digits.';
    END IF;
    -- Check if it's numeric
    IF NEW.mobileno NOT REGEXP '^[0-9]{10}$' THEN
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'Mobile number must contain only digits.';
    END IF;
END
//
DELIMITER ;
